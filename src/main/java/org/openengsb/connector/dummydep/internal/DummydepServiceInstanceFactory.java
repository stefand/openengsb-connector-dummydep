...
public class DummydepServiceInstanceFactory extends AbstractConnectorInstanceFactory<DummydepServiceImpl> {

    private DependencyDomainEvents dependencyEvents;

    @Override
    public Connector createNewInstance(String id) {
        DummydepServiceImpl service = new DummydepServiceImpl(id);
    ...
    @Override
    public void doApplyAttributes(DummydepServiceImpl instance,
